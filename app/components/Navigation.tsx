          ...
          <div className="flex gap-3 items-center">
            ...
            <div ref={menuRef} className="relative">
              <button
                ...
                className="flex gap-2 items-center font-medium text-[#181818] px-4 py-2.5 border border-[#E4E4E7] rounded-[10px] shadow-xs cursor-pointer hover:opacity-80 transition-opacity"
              >
                <svg
                  width="16"
                  height="16"
              ...
              {/* Dropdown */}
              <div
                className={`absolute top-full left-0 z-50 mt-1 p-5 bg-white border border-[#E4E4E7] rounded-lg shadow-lg transition-all duration-300 ${
                  visible
              ...
              >
                ...
                <div className="absolute top-0 left-0 right-0 h-[3px] bg-indigo-600 rounded-t-lg" />

                <div className="font-semibold text-2xl text-[#09090B] mt-1">
                  Genres
                </div>
                ...
                <div className="flex flex-wrap gap-2 max-w-[540px]">
                  {genres.map((genre, i) => (
                    <button
                      key={i}
                      className="border cursor-pointer hover:border-indigo-400 hover:text-indigo-600 duration-200 text-xs font-semibold py-1 pl-3 pr-2 border-[#E4E4E7] rounded-full flex items-center gap-1.5 text-[#09090B]"
                    >
                      {genre}
                      <svg
                        width="14"
